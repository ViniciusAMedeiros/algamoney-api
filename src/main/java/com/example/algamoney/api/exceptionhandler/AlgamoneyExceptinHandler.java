...
@ControllerAdvice
public class AlgamoneyExceptinHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex, WebRequest request) {
		String mensagemUsuario = messageSource.getMessage("resurso.nao-encontrado", null,LocaleContextHolder.getLocale());
